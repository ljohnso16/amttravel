...
<div class="home container text-center">
	<div id="primary" class="text-center">
		<main id="main" class="site-main">
				<header>
					<h3 class="home page-title screen-reader-text" id="home-title">Ten Reasons You Should Use AMT, an American Express Travel Representative:</h3>
				</header>
...
<div class="home-item" style="clear:both">
	...
	<div class="col-md-12 col-lg-12 text-center">
		<a href="http://amt-travel-insiders.com/travel-guides"><img src="http://amt-travel-insiders.com/wp-content/uploads/2015/05/s.africa-150x150.png" alt="s.africa"/></a>
		<p>Download complimentary Travel Guides from worldwide destinations.</p>
		<strong>Call (800) 999-2599 now</strong>
			<h4 class="video_title_header video_general">What do we mean by "Insiders" ? </h4>
...
<div class="choose-location-div col-xs-12 col-sm-6 col-md-6 col-lg-3 center-block">
	<div id="location-1" class="location-item">
		<div class="location-label">
			<p>
				<a href="http://amt-travel-insiders.ljohnsonsolutions.com/africa">africa</a>
			</p>
		</div>
		<div class="hidden location-text-content">
			<ul>
...
<div class="choose-location-div col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
	<div id="location-2" class="location-item">
		<div class="location-label">
			<a href="http://amt-travel-insiders.ljohnsonsolutions.com/asia">Asia</a>
		</div>
		<div class="location-text-content hidden">
			<ul>
...
<div class="choose-location-div col-xs-12 col-sm-6 col-md-6 col-lg-3  text-center">
	<div id="location-3" class="location-item">
		<div class="location-label">
			<a href="http://amt-travel-insiders.ljohnsonsolutions.com/europe">Europe</a>
		</div>
		<div class="location-text-content hidden">
			<ul>
